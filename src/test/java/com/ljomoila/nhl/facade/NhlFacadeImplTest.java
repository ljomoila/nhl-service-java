...
public class NhlFacadeImplTest {
    ...
    public void testGetTeams() {
        ...
        assertEquals(teams.get(0).getId(), 1);
        assertEquals(teams.get(0).getName(), "New Jersey Devils");
        assertEquals(teams.get(0).getShortName(), "New Jersey");
        assertEquals(teams.get(0).getAbbreviation(), "NJD");
    }
